...
clang -c --target=i686-pc-none-elf -march=i686 -ffreestanding -Wall -Wextra -Ikernel/include -Ilibc/include -o libc/src/string/memcpy.o libc/src/string/memcpy.c
clang -c --target=i686-pc-none-elf -march=i686 -ffreestanding -Wall -Wextra -Ikernel/include -Ilibc/include -o libc/src/string/strdup.o libc/src/string/strdup.c
clang -c --target=i686-pc-none-elf -march=i686 -ffreestanding -Wall -Wextra -Ikernel/include -Ilibc/include -o libc/src/string/strlen.o libc/src/string/strlen.c

ld.lld -M -T linker.ld -o tinyos.bin -O2 -nostdlib kernel/src/arch/x86/interrupts.o kernel/src/arch/x86/preboot.o kernel/src/arch/x86/drivers/ps2/i8042.o kernel/src/arch/x86/drivers/manager.o kernel/src/arch/x86/boot.o kernel/src/arch/x86/descriptors.o kernel/src/arch/x86/isr.o kernel/src/arch/x86/pic.o kernel/src/drivers/display/vga.o kernel/src/drivers/ps2/keyboard.o kernel/src/drivers/manager.o kernel/src/irq/irq.o kernel/src/memory/kmalloc.o kernel/src/memory/manager.o kernel/src/term/term.o kernel/src/term/vgaterm.o kernel/src/init.o kernel/src/log.o libc/src/string/memcpy.o libc/src/string/strdup.o libc/src/string/strlen.o