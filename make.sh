...
ld.lld -T linker.ld -o tinyos.bin -O2 -nostdlib kernel/src/arch/x86/preboot.o kernel/src/arch/x86/boot.o kernel/src/drivers/display/vga.o kernel/src/term/term.o kernel/src/term/vgaterm.o kernel/src/init.o kernel/src/log.o